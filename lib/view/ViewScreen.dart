...
import 'package:new_api_get_view/resource/StyaleResource.dart';
import 'package:new_api_get_view/resource/UrlResource.dart';
import 'package:new_api_get_view/utility/ApiHandler.dart';
import 'package:new_api_get_view/utility/ErrorHandler.dart';
import 'package:new_api_get_view/utility/NoConaction.dart';
    ...
    try {
      ...
      if (ex.code.toString() == "500") {
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => NoConaction()));
      }
    }
  }
